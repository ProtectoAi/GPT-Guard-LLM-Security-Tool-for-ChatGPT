...
export const Answer = ({
    ...
    return (
        <>
            <Stack className={handleDescription() ? styles.maskContainer : styles.answerContainer} tabIndex={0}>
                <div className={styles.answerHeaderText}>Secured results by GPT Guard</div>
                <Stack.Item grow>
                    <ReactMarkdown
                        linkTarget="_blank"
                ...
                <Stack horizontal className={styles.answerFooter}>
                    ...
                    <Stack.Item className={styles.answerDisclaimerContainer}>
                        <span className={styles.answerDisclaimer}> {handleDescription() ? description?.text : "AI-generated content may be incorrect "} </span>
                    </Stack.Item>
                </Stack>
                {chevronIsExpanded &&
